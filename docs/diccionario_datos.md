...
Este archivo ha sido generado a partir del diseño de registro oficial del INE (`diseno_registro_2021_en_adelante.xlsx`, **2021 en adelante**).
...
*Variable numérica o de texto libre: no tiene un diccionario de códigos asociado.*
